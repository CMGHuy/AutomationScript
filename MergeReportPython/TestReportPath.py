...
class TestReport:
    ...
    def modifyTestCaseReport(self,inputTestCaseFile):
        ...
        print(inputTestCaseFile)
        soup = BeautifulSoup(open(inputTestCaseFile,encoding="utf8"),"html.parser")
        ...
        for row in tableRows:
            ...
            if len(column) > 0:
                ...
                column[2].extract()
                column[4].extract()
        with open(inputTestCaseFile, "w",encoding="utf8") as file:
            file.write(str(soup))            
###############################################################################################################
...
class TestSuite:
    def __init__(self,inputTestSuitePath):
        ...
        self.soup = BeautifulSoup(open(inputTestSuitePath,encoding="unicode_escape"),'html.parser')
